...
function(c){c.preventDefault();c=b(this);if("disabled"==c.attr("disabled"))return!1;a.isMultiple?c.toggleClass("selected"):c.siblings().removeClass("selected").end().addClass("selected")})},_unbindEvents:function(){this.$triggerElement.unbind("click");this.$c.find(".mobileSelect-savebtn").unbind("click");this.$c.find(".mobileSelect-clearbtn").unbind("click");this.$c.find(".mobileSelect-cancelbtn").unbind("click");this.$c.find(".mobileSelect-control").unbind("click")},sync:function(){var a=this.$e.val();
this.isMultiple||(a=[a]);this.$c.find("a").removeClass("selected");for(var c in a)this.$c.find('a[data-value="'+a[c]+'"]').addClass("selected")},syncR:function(){var a=[];this.$c.find(".selected").each(function(){a.push(b(this).data("value"))});this.$e.val(a);this.$e.trigger("change")},hide:function(){this.$c.children("div").addClass("anim-"+this.animation);var a=this;this._updateBtnCount();setTimeout(function(){a.$c.hide();b("body").removeClass("mobileSelect-noscroll");a.onClose.apply(a.$e)},this.animationSpeed)},
show:function(){this.$c.show();this.sync();b("body").addClass("mobileSelect-noscroll");var a=this;setTimeout(function(){a.$c.children("div").removeClass(b.mobileSelect.animations.join(" "))},10);var c=this.$c.find(".mobileSelect-filter");this.filterable&&c.val()&&c.val("").trigger("input");this.onOpen.apply(this.$e)},_setUserOptions:function(){this.isMultiple=this.$e.attr("multiple")?!0:!1;void 0!==this.$e.data("title")&&(this.title=this.$e.data("title"));void 0!==this.$e.data("animation")&&(this.animation=
this.$e.data("animation"));void 0!==this.$e.data("animation-speed")&&(this.animationSpeed=this.$e.data("animation-speed"));void 0!==this.$e.data("padding")&&(this.padding=this.$e.data("padding"));void 0!==this.$e.data("btntext-save")&&(this.buttonSave=this.$e.data("btntext-save"));void 0!==this.$e.data("btntext-select-all")&&(this.buttonSelectAll=this.$e.data("btntext-select-all"));void 0!==this.$e.data("btntext-clear")&&(this.buttonClear=this.$e.data("btntext-clear"));void 0!==this.$e.data("btntext-cancel")&&
(this.buttonCancel=this.$e.data("btntext-cancel"));void 0!==this.$e.data("theme")&&(this.theme=this.$e.data("theme"));"none"===this.animation&&(this.animationSpeed=0)},_extractOptions:function(){var a=[];b.each(this.$e.find("option"),function(c,g){var d=b(g);if(d.text()){if(d.parent().is("optgroup"))var e=d.parent().attr("label"),f=d.parent().prop("disabled");else f=e=!1;a.push({value:d.val(),text:b.trim(d.text()),disabled:d.prop("disabled"),group:e,groupDisabled:f})}});this.options=a},destroy:function(){this.$e.removeAttr("data-msid");
this._unbindEvents();this.$triggerElement.remove();this.$c.remove();this.$e.show();console.log("done ")},refresh:function(){this._extractOptions();this._appendOptionsList();this._unbindEvents();this._bindEvents()}};b.mobileSelect={elements:{},animations:"anim-top anim-bottom anim-left anim-right anim-opacity anim-scale anim-zoom anim-none".split(" ")};b.fn.mobileSelect.defaults={id:"",template:'<div><div class="mobileSelect-title"></div><div class="search-wrap"><i class="fa fa-search"></i><input class="form-control mobileSelect-filter" type="search" /></div><div class="list-container"></div><div class="mobileSelect-buttons"><a href="#" class="mobileSelect-selectallbtn"></a><a href="#" class="mobileSelect-clearbtn"></a><a href="#" class="mobileSelect-savebtn"></a><a href="#" class="mobileSelect-cancelbtn"></a></div></div>',
